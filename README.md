...
im Portal finden. Wir brauchen den "GLOBAL UNICAST ENCRYPTION KEY (GUEK)".
...
Zuerst muss der GUEK und die zu entschlüsselnden Daten in die Skripte eingetragen werden.  
...
Der Datenframe ist mit COSEM-Security 0 veschlüsselt, den genauen Standard (siehe unbekannte Bytes) kenne ich nicht.
Die entschlüsselten Daten entsprechen grundsätzlich dem DSMR Standard, es gibt aber 12 unbekannte Bytes am Ende der entschlüsselten Daten.
...
**db 08**: Statischer Header, Interpretation unbekannt
...
**82 01 f2 30**: Interpretation unbekannt
